...
import { Design, DesignFilter, Paginator, SortingState, SortOrder } from "@/types/common";
...
import UpdateDesignModal from "./UpdateDesignModal";
import DeleteDesignModal from "./DeleteDesignModal";

const initialFilter:DesignFilter = {
  name: '',
  slug: '',
}
...
export default function DesignManagement() {
  ...
  const [filter, setFilter] = useState<DesignFilter>(initialFilter)
  ...
  const fetchDesignData = async () => {
    try {
      setIsLoading(true);
      const response = await getDesigns(filter, sort, paginator) //chnage to design
          ...
          <div className="flex flex-row items-start gap-2 justify-center">
            <div className="flex flex-row">
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="name">Design Name</SelectItem>
  ...
  return (
    <div className="p-5 flex flex-col gap-2 w-full">
      ...
      <DeleteDesignModal 
        ...
        refreshFunction={fetchDesignData}
